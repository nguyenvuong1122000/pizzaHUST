...
const initialState = {
  // localStorage.getItem('usernameHUST')
  username: localStorage.getItem('usernameHUST') ?  localStorage.getItem('usernameHUST') : '',
  token: localStorage.getItem('tokenHUST') ?  localStorage.getItem('tokenHUST') : '',
};
