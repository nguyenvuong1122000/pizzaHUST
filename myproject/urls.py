...
urlpatterns = [
    ...
    path('forgot/done/', auth_views.PasswordResetDoneView.as_view(template_name="profiles/forgot_done.html"),
         name="forgot-done"),
    ...
    path('forgot/complete/',
         auth_views.PasswordResetCompleteView.as_view(template_name="profiles/forgot_complete.html"),
    ...
    path('toppingamount/<int:pk>/', project_view.ToppingAmountDetail.as_view(),
         name=project_view.ToppingAmountDetail.name),
