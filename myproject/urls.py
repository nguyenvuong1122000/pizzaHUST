...
urlpatterns = [
    ...
    path('toppings/',project_view.ToppingList.as_view(), name = project_view.ToppingList.name),
    path('toppings/<int:pk>/',project_view.ToppingDetail.as_view(), name = project_view.ToppingDetail.name),
    path('toppingamount/',profiles_view.ToppingAmountList.as_view(), name=profiles_view.ToppingAmountList.name),
    path('toppingamount/<int:pk>/',profiles_view.ToppingAmountDetail.as_view(), name = profiles_view.ToppingAmountDetail.name),
    ...
    path('profile/', profiles_view.Profilelist.as_view(), name=profiles_view.Profilelist.name),
