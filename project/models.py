...
class ToppingAmount(models.Model):
    ...
    topping = models.ForeignKey('Topping', related_name='topping_amount', on_delete=models.SET_NULL, null=True,
                                blank=True)
